...
def xrpcc_run_cmd(line, config):
    logger = logging.getLogger('bot.cmd.xrpcc')
    ...
    for i in jsonData:
        ...
        string = 'PRIVMSG ' + config['channel'] + ' :' + red + '[CoinMarketCap/Ripple (XRP)]' + reset + ' > '  + '$' + i['price_usd'] + ' USD'  + ' | ' + i['price_btc'] + ' BTC  | (7d) ' + var7dcolor + i['percent_change_7d'] + '%' + reset + ' | (24h) ' + var24hcolor + i['percent_change_24h'] + '%' + reset + ' | (1h) ' + var1hcolor + i['percent_change_1h'] + '%'
